...
const COMPUTER = (new URL('assets/computers_1-transformed.glb', import.meta.url)).toString();
const INTER_MEDIUM = (new URL("assets/Inter-Medium.woff", import.meta.url)).toString();
...
export function Computers({ name, ...props }) {
  const { nodes: n, materials: m } = useGLTF(COMPUTER)
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <ScreenText name={name} frame="Object_209" panel="Object_210" y={5} position={[-1.43, 2.5, -1.8]} rotation={[0, 1, 0]} />
      <ScreenText name={name} invert frame="Object_212" panel="Object_213" x={-5} y={5} position={[-2.73, 0.63, -0.52]} rotation={[0, 1.09, 0]} />
      <ScreenText name={name} invert frame="Object_215" panel="Object_216" position={[1.84, 0.38, -1.77]} rotation={[0, -Math.PI / 9, 0]} />
      <ScreenText name={name} invert frame="Object_218" panel="Object_219" x={-5} position={[3.11, 2.15, -0.18]} rotation={[0, -0.79, 0]} scale={0.81} />
      <ScreenText name={name} frame="Object_221" panel="Object_222" y={5} position={[-3.42, 3.06, 1.3]} rotation={[0, 1.22, 0]} scale={0.9} />
      <ScreenText name={name} invert frame="Object_224" panel="Object_225" position={[-3.9, 4.29, -2.64]} rotation={[0, 0.54, 0]} />
      <ScreenText name={name} frame="Object_227" panel="Object_228" position={[0.96, 4.28, -4.2]} rotation={[0, -0.65, 0]} />
      <ScreenText name={name} frame="Object_230" panel="Object_231" position={[4.68, 4.29, -1.56]} rotation={[0, -Math.PI / 3, 0]} />
...
function ScreenText({ name, invert, x = 0, y = 1.2, ...props }) {
  ...
  return (
    <Screen {...props}>
      ...
      <Text font={INTER_MEDIUM} position={[x, y, 0]} ref={textRef} fontSize={4} letterSpacing={-0.1} color={!invert ? 'black' : '#35c19f'}>
        {name}
      </Text>
    </Screen>
  )
